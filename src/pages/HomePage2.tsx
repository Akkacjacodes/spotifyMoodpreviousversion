  ...
  return (
    <>
      {isLoading ? (
        ...
        <>
          <Navbar />
          <div className="flex flex-col-reverse w-full m-12 justify-center gap-4">
            <iframe
              className="h-[700px] w-3/4"
            ...
            <div className="">
              ...
              <div className="my-16">
                <button
                  ...
                  className=" rounded-md border border-transparent bg-green-600 pl-5 pr-5 py-3 text-base font-medium text-white hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
                >
                  Get The Playlist
                </button>
              </div>
